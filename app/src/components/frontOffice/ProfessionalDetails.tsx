...
function ProfessionalDetails() {
  ...
  const availabilityTable = record.availability
    ? record.availability.map(({ day, times }) => (
        <tr key={day}>
          ...
          {times.map(({ slot, available, _id }) => (
            <td
              key={_id}
              className="px-5 py-5 border-b border-gray-200 text-center  bg-white font-bold text-orange-800 text-sm"
            >
              {available ? (
                <svg
    ...
    records.length != 0
      ? records.slice(0, 4).map((record, index) => (
          <div className="">
            <Link
              reloadDocument
              to={`/professional/details/${record._id}`}
              key={index}
            >
              <div className="text-center my-2">
                <img
                  ...
                  alt=""
                />
                <p className="text-main-color">{record.firstName}</p>
              </div>
            </Link>
          </div>
        ))
          ...
          <div className="md:flex no-wrap md:-mx-2 ">
            ...
            <div className="w-full md:w-3/12 md:mx-2">
              ...
              <div className="flex flex-col  bg-white p-3 mt-4 hover:shadow">
                ...
                <iframe
                  className="w-68 mx-1 h-52  mt-3"
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d21339.59057156378!2d-7.651467136016285!3d33.56440130614434!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xda7d3a2e5439e89%3A0xbf888b237cbe56b1!2sARK%20X%20Talent%20Factory!5e0!3m2!1sfr!2sma!4v1716376493701!5m2!1sfr!2sma"
                  loading="lazy"
                ></iframe>
              ...
              <div className="bg-white p-3 my-5 shadow-sm rounded-sm">
                <div className="grid grid-cols-2">
                  <div>
                    ...
                    <ul className="list-inside space-y-2">{experiences}</ul>
                  </div>
                  <div>
                    <div className="flex items-center space-x-2 font-semibold text-gray-900 leading-8 mb-3">
                      <span className="text-green-500">
                    ...
                    <ul className="list-inside space-y-2">{educations}</ul>
                  </div>
                </div>
              ...
              <div className="bg-white my-5 p-3 shadow-sm rounded-sm ">
                <div className="overflow-x-auto">
                  <table className="table-auto border-collapse  border-none">
                    <thead>
                      <tr>
                        <th className="px-5 py-3 border-b-2 border-gray-200 bg-yellow-100 text-center text-sm w-7/12 font-semibold text-orange-800  ">
                          {" "}
                          DAY / TIME
                        </th>
