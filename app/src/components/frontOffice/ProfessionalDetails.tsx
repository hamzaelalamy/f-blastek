              ...
              <div className="bg-white my-5 p-3 shadow-sm rounded-sm ">
                <div className="overflow-x-auto">
                  <table className="table-auto border-collapse  border-none">
                    <thead>
                      <tr>
                        <th className="px-5 py-3 border-b-2 border-gray-200 bg-yellow-100 text-left text-sm rounded-2xl w-7/12 font-semibold text-gray-700  "> DAY / TIME</th>
                        {availableTimeSlots.map((timeSlot, index) => (
                          <th
                            key={index}
                            className="px-5 py-3 border-b-2 border-gray-200 bg-yellow-100 text-left text-sm rounded-2xl w-[50px] font-semibold text-gray-700  "
                          >
                            {timeSlot}
                          </th>
                        ))}
