...
function InterestSelectionCard(props: React.PropsWithChildren<props>) {
    return (
        <Link to={props.nav}>
            <div className="relative flex flex-col mt-6 text-gray-700 bg-[#bfffd3] shadow-md bg-clip-border rounded-xl max-w-xs mx-2 hover:scale-110 duration-300 ease-in-out animate-cardEntrance">
